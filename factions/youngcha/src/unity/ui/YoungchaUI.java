...
//idk
public class YoungchaUI{
    //ew.. weird
    public static final YoungchaUI self;
    ...
    public void init(){
        ...
        Events.run(Trigger.update, () -> {
            ...
            if(top != null){
                ...
                top.visible(() -> ReflectUtils.invoke(Vars.ui.hudfrag.blockfrag, method) == Boolean.TRUE || 1 == one);
    ...
    public void reloadBlocks(){
        ...
        for(Block b : Vars.content.blocks()){
            if(FactionRegistry.faction(b) == null){
                b.placeablePlayer = included.contains(Faction.vanilla);
            }else{
                b.placeablePlayer = included.contains(FactionRegistry.faction(b));
            }
            if(!collapsed){
