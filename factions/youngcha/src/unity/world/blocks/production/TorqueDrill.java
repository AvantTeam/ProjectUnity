...
public class TorqueDrill extends Drill implements GraphBlock{
    ...
    public class TorqueDrillBuild extends DrillBuild implements GraphBuild{
        ...
        public void draw(){
            ...
            DrawUtils.drawRotRect(rotorRotateRegion, x, y, 24f, 3.5f, 3.5f, 450f - rot * 0.25f, shaftRot, shaftRot + 180f);
            DrawUtils.drawRotRect(rotorRotateRegion, x, y, 24f, 3.5f, 3.5f, 450f - rot * 0.25f, shaftRot + 180f, shaftRot + 360f);

            //shaft
            Draw.rect(mbaseRegion, x, y, fixedRot);

            DrawUtils.drawRotRect(wormDrive, x, y, 24f, 3.5f, 3.5f, fixedRot, rot, rot + 180f);
            DrawUtils.drawRotRect(wormDrive, x, y, 24f, 3.5f, 3.5f, fixedRot, rot + 180f, rot + 360f);
            DrawUtils.drawRotRect(rotateRegion, x, y, 24f, 3.5f, 3.5f, fixedRot, rot, rot + 180f);
