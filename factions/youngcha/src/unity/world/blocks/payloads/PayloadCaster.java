            ...
            if(isCasting()){
                ...
                if(progress < castTime){
                    ...
                    if(moveprog < keyframe1){
                        ...
                        DrawUtils.drawRectOrtho(cast.region, pivot.x + cubepos.x, pivot.y + cubepos.y, -4, cast.region.width * 0.25f, cast.region.height * 0.25f, ang - 90, rotdeg());
                    }else if(moveprog < keyframe2){
                        //casted thing drops down
                        DrawUtils.drawRectOrtho(platter, pivot.x, pivot.y, -5, 0, -2, platter.width * 0.25f, platter.height * 0.25f, 45, rotdeg());
                        DrawUtils.drawRectOrtho(platterside, pivot.x, pivot.y, 0, 0, -12, 4, 16, 45 - 90, rotdeg());
