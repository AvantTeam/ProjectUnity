...
public class LightFilter extends Block{
	public static final Color[] colors = {Color.white, Color.red, Color.green, Color.blue},
		ncolors = {Color.black, Color.cyan, Color.magenta, Color.yellow};
	...
	public LightFilter(String name){ this(name, false); }
	...
	public class LightFilterBuild extends Building implements LightRepeaterBuildBase{
		...
		@Override
		public Integer config(){ return color; }
		...
		@Override
		public void buildConfiguration(Table table){ for (int i = 0; i < 4; i++) addColorButton(table, i); }
