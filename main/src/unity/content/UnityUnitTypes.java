...
public class UnityUnitTypes{
    ...
    public static void load(){
        ...
        fin = new UnityUnitType("fin"){{
            ...
            weapons.add(new Weapon(name + "-launcher"){{
                ...
                bullet = new MortarBulletType(7f, 4f){{
                    ...
                    lifetime = 65f;
                    fragBullet = Bullets.placeholder;
                    fragBullets = 7;
                    fragLifeMax = 0.15f;
                    fragLifeMin = 0.15f;
                    despawnHit = true;
        ...
        amphibi = new UnityUnitType("amphibi"){{
            ...
            legExtension = -3f;
            //legLengthScl = 0.6f;
            legLengthScl = 0.6f; // i'm just.. guessing.
            groundLayer = 65f;
            rippleScale = 1f;
            transformTime = 10f;
        ...
        desolation = new UnityUnitType("desolation"){{
            ...
            legForwardScl = 0.3f;
            legLength = 672f * (1f - (legForwardScl * 0.85f * 0.5f));
            legExtension = -48f;
            legCount = 8;
            legGroupSize = 2;
            legPairOffset = 1f;
