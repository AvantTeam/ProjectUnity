...
public class BlockMovement{
    ...
    //like starting points for locations based on the direction you want? hard to explain. You wouldnt need it directly anyway.
    ...
    */
    ...
    public static Seq<Building> getAllContacted(Building root, int direction, int max, Boolf<Building> bool){
        PriorityQueue<Building> queue = new PriorityQueue<>(10, (a, b) -> {//require ordering to be projection of the block's leading edge along  push direction.
